...
export default function FailedTask(){
    return (
        <div className="h-full flex-shrink-0 w-[352px] p-5 bg-purple-400 rounded-xl" >
        ...
        <div className="mt-20">
                    <button className="bg-green-500 py-3 px-3 text-sm rounded-full w-full ease-in duration-150 hover:bg-green-600">Failed</button>
                </div>
    </div>
    )
}